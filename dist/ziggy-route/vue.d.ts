import{App,ComponentOptions}from'vue';import{C as Config}from'../index-B8x4plc9.js';interface Vue2CompatApp{version:string;mixin:(m:ComponentOptions)=>void;[key:string]:any;}type VueApp=App|Vue2CompatApp;
/** -------------------------------------------------------
